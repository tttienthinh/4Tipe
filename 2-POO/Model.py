...
if __name__ == "__main__":
    ...
    # model testing
    l1 = Layer(input_n=2, output_n=5, activation=Activation.sigmoid, d_activation=Activation.d_sigmoid)
    l2 = Layer(input_n=5, output_n=2, activation=Activation.sigmoid, d_activation=Activation.d_sigmoid)
    """
    np.random.seed(2)
