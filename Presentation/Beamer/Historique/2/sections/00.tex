...
\begin{tabular}{ l || c | c  }
    1 & Le traitement acoustique  & \includegraphics[height=0.25\textheight]{1-Incendie-3.jpg} \\ \hline \\
    2 & L'apprentissage automatique & \includegraphics[height=0.25\textheight]{2-Reseau.png} \\ \hline \\
    3 & Le décodage & \includegraphics[height=0.25\textheight]{3-Matching.png} \\ \hline
\end{tabular}
\end{frame}
