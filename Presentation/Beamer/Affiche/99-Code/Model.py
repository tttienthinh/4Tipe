...
class Model:
    ...
    def predict_loss(self, input_data:np.ndarray, target_output:np.ndarray):  # target_output is expected data
...
class ModelClassification(Model):
    """
    Permet de calculer le taux de bonne réponse en plus acc
    """
    def __init__(self, layers:list, loss_function, d_loss_function):
