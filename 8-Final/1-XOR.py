...
# model creation
model = Model([
        Layer(2,  2, lr=0.3, activation=Activation.sigmoid, d_activation=Activation.d_sigmoid),
        LayerOptimizer(2,  3, lr=0.3, gamma=0.3, activation=Activation.softmax, d_activation=Activation.d_softmax),
    ],
